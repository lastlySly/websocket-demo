...
function connect() {
    ...
    stompClient.connect({}, function (frame) {
        ...
        //订阅群聊消息
        stompClient.subscribe('/chatroom/chat', function (result) {
        	showContent(JSON.parse(result.body));
        });
        
        //订阅在线用户消息
        stompClient.subscribe('/chatroom/onlineuser', function (result) {
...
function sendContent() {
    stompClient.send("/app/chatroomcontroller/mychat", {}, JSON.stringify({'content': $("#content").val()}));
